...
def main():
    ...
    # parser.add_argument('--project_name', default='CD_bceloss_base_transformer_pos_s4_dd8_dedim8_LEVIR_b32_lr0.01_train_val_300_linear_sigFalse', type=str)
    parser.add_argument('--project_name', default='auxilary_model_kmcuda', type=str)
